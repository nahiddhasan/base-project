...
const RegisterPage = () => {
  ...
  return (
    <div className="flex items-center justify-center h-full w-full bg-[url('/img/loginBg.jpg')] bg-contain text-white">
      <div className="w-[30%] h-3/4 flex gap-2 justify-between rounded-md bg-zinc-900/65 backdrop-blur-sm overflow-hidden ">
        <form
